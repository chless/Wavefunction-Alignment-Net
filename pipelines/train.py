...
# import sys  
sys.path.insert(0, '/home/weixinran/MADFT-NN/src')
import torch
...
from madftnn.utility.hydra_config import Config
from madftnn.training.module import LNNP
from madftnn.training.logger import CSVLogger, get_latest_ckpt
from madftnn.utility.callbacks import EMA
from madftnn.training.data import DataModule
