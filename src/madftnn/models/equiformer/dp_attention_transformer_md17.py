...
def dot_product_attention_transformer_exp_l2_md17(irreps_in, radius, num_basis=128, 
    ...
    model = DotProductAttentionTransformerMD17(
        ...
        irreps_node_embedding='128x0e+128x1e+128x2e+128x3e+128x4e', num_layers=num_layers, #'128x0e+64x1e+32x2e+16x3e+8x4e'
        irreps_node_attr='1x0e', irreps_sh='1x0e+1x1e+1x2e+1x3e+1x4e',
        max_radius=radius,
        number_of_basis=num_basis, fc_neurons=[64, 64], basis_type='exp',
        irreps_feature='512x0e+256x1e+128x2e+64x3e+32x4e',#
        irreps_head='32x0e+16x1e+8x2e+4x3e+2x4e', num_heads=4, irreps_pre_attn=None,
        rescale_degree=False, nonlinear_message=False,
