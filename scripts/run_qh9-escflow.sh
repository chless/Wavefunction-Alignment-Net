python pipelines/train.py --config-name=config.yaml wandb.open=True job_id=QH9 \
model_backbone=QHNet_backbone_No lr=0.0005 enable_hami=True \
hami_weight=1  batch_size=32 inference_batch_size=256 devices=[7] schedule=polynomial schedule.lr_warmup_steps=1000 \
